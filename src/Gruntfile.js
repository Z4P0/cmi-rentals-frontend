module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      data: {
        files: [{expand: true, cwd: 'data', src:['*.json'], dest: build_folder+'data'}]
      },
      fonts: {
      ...
      favicons: {
        files: [{expand: true, cwd: './', src:['favicon.ico, apple-touch-icon.png'], dest: build_folder+''}]
      },
      js_libs: {
    ...
    jade: {
      index: {
        ...
        files: [{expand: true, cwd: './', src: ['*.jade', '!_*.jade'], dest: build_folder, ext: '.html', flatten: true }]
      }
    },
